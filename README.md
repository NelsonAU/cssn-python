...
The backend uses a self-contained NEAT implementation (`neat_impl.py`).
The frontend is HTML/JS/CSS.
...
paper. The source code tries to be very explicit about marking everything as
either being verbatim from a specific paper section or [NOT IN PAPER].
